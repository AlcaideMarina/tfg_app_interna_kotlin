package com.example.hueverianieto.ui.views.boxesandcartonsresources
...
import com.example.hueverianieto.databinding.ActivityBoxesAndCartonsResourcesBinding
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class BoxesAndCartonsActivity : BaseActivity() {

    private lateinit var binding: ActivityBoxesAndCartonsResourcesBinding
    ...
    override fun setUp() {
        ...
        this.binding = ActivityBoxesAndCartonsResourcesBinding.inflate(layoutInflater)
        ...
        appBarConfiguration = AppBarConfiguration(
            setOf(R.layout.fragment_all_boxes_and_cartons_resources)
        )
