package com.example.hueverianieto.ui.views.finalproductcontrol
...
@AndroidEntryPoint
class FinalProductControlActivity : BaseActivity() {

    private lateinit var binding: ActivityFinalProductControlBinding
    ...
    override fun setUp() {
        ...
        this.binding = ActivityFinalProductControlBinding.inflate(layoutInflater)
