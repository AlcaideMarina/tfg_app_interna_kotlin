...
@AndroidEntryPoint
class HensResourcesActivity : BaseActivity() {

    private lateinit var binding: ActivityHensResourcesBinding
    ...
    override fun setUp() {
        ...
        this.binding = ActivityHensResourcesBinding.inflate(layoutInflater)
