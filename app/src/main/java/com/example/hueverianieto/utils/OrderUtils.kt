...
object OrderUtils {
    ...
    fun getOrderDataGridModel(orderData: OrderData, isEnable: Boolean): List<GridTextItemData> {
        ...
        return listOf(
            ...
            GridTextItemData(
                ...
                null,
                isEnable,
                response = dbOrderModel.xlDozenQuantity.toString() + "   uds."
            ),
            GridTextItemData(
                3,
    ...
    fun getOrderDataModifyGridModel(
        orderData: OrderData,
        eggPricesData: EggPricesData,
        isEnable: Boolean
    ): List<GridTextItemData> {
        ...
        return listOf(
            ...
            GridTextItemData(
                3,
                true,
                (dbOrderModel.xlDozenPrice ?: eggPricesData.xlDozen).toString() + " €/ud",
                isTextLeft = false
            ),
            GridTextItemData(
                4,
            ...
            GridTextItemData(
                6,
                true,
                (dbOrderModel.xlBoxPrice ?: eggPricesData.xlBox).toString() + " €/ud",
                isTextLeft = false
            ),
            GridTextItemData(
                7,
            ...
            GridTextItemData(
                10,
                true,
                (dbOrderModel.lDozenPrice ?: eggPricesData.lDozen).toString() + " €/ud",
                isTextLeft = false
            ),
            GridTextItemData(
                11,
            ...
            GridTextItemData(
                13,
                true,
                (dbOrderModel.lBoxPrice ?: eggPricesData.lBox).toString() + " €/ud",
                isTextLeft = false
            ),
            GridTextItemData(
                14,
            ...
            GridTextItemData(
                17,
                true,
                (dbOrderModel.mDozenPrice ?: eggPricesData.mDozen).toString() + " €/ud",
                isTextLeft = false
            ),
            GridTextItemData(
                18,
            ...
            GridTextItemData(
                20,
                true,
                (dbOrderModel.mBoxPrice ?: eggPricesData.mBox).toString() + " €/ud",
                isTextLeft = false
            ),
            GridTextItemData(
                21,
            ...
            GridTextItemData(
                24,
                true,
                (dbOrderModel.sDozenPrice ?: eggPricesData.sDozen).toString() + " €/ud",
                isTextLeft = false
            ),
            GridTextItemData(
                25,
            ...
            GridTextItemData(
                27,
                true,
                (dbOrderModel.sBoxPrice ?: eggPricesData.sBox).toString() + " €/ud",
                isTextLeft = false
            ),
        )
    }
